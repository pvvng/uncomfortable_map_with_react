...
- ### 5-1. 프로젝트 중 신경 쓴 부분
  ...
  - ##### 실시간 위치 데이터 전송 커스텀 훅
    ...
    - [커스텀 훅이 어떤 방식으로 동작하는지 궁금하시다면?](https://velog.io/@pvvng/%EC%BB%A4%EC%8A%A4%ED%85%80-%ED%9B%85-%EC%82%AC%EC%9A%A9%ED%95%98%EA%B8%B0)
  ...
  - ##### 카카오 맵 API 사용과 Redux 상태 관리, localStorage에 이동 경로 저장, 관리하기
    ...
    - [구체적으로 뭘 했는지 궁금하시다면?](https://velog.io/@pvvng/react-Kakao-map%EA%B3%BC-redux-%EA%B7%B8%EB%A6%AC%EA%B3%A0-localStorage)
  ...
  - ##### 공공데이터 API 활용
    ...
    - [공공데이터 활용기가 궁금하시다면?](https://velog.io/@pvvng/%EA%B3%B5%EA%B3%B5%EB%8D%B0%EC%9D%B4%ED%84%B0-%ED%99%9C%EC%9A%A9%ED%95%98%EA%B8%B0)
